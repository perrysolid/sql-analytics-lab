-- Schema, indexes, analytics views, and quality checks for the Amazon books pipeline.
-- Run this in pgAdmin if you want to recreate the database objects outside Airflow.
